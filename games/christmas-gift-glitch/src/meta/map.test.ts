...
describe('Christmas journey chapters', () => {
  ...
  it('lays doors bottom-up in a zigzag with wider chapter gaps', () => {
    ...
    equal(seventh.y - eighth.y, NODE_STEP + 94, 'chapter boundary adds an extra gap')
    ok(contentHeight > last.y)
    equal(seventh.boss, true, 'seventh dispatch closes chapter 1')
