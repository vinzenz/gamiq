 ...
 * pairwise power-up combos in `combos.ts`, and the five blockers (cover, blocker, cursed
 * ice, lock, spreader) in `obstacles.ts`, and the boss house mechanic in `boss.ts`; all are
